...
class CloudDatabase:
    ...
    async def get_chat(self):
        if not self.chat or not self.input_chat:
            ...
            if not chat:
                ...
                await self._client(EditPhotoRequest(self.chat, photo))
    ...
    async def send_data(self, message: Union[types.Message, str]):
        ...
        return (
            await self._client.send_message(self.chat, message, parse_mode="HTML")
    ...
    async def get_data(self, message_id: int):
        ...
        return await self._client.get_messages(self.chat, message_id)
